...
class Farm:
    ...
    Farms:
        - are initialized by the farmer who owns them
    ...
    def __init__(self, owner, unique_id, model_adoptable_pastures, farm_data):
        ...
        self.legal_form = farm_data['LegalForm']
        self.percent_rented_land = farm_data['PercentRentedLand']
    ...
    def _get_differential_npvs(self, farm_adoptable_pastures):
        ...
        between adopting and keeping the actual pasture.
        ...
        for pasture in farm_adoptable_pastures:
            npv_adoption = pasture.npv_adoption(self.owner.confidence,
                                                self.pasture_type)
