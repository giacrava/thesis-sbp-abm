...
class Government(mesa.Agent, abc.ABC):
    """
    Base class for the agents reporting payments for ecosystem services for
    pastures adoption.
    ...
    def _retrieve_payments(self, payments):
        ...
        ------
        KeyError
            Risen if the "payments" dictionary does not have a key
...
class SownPermanentPasturesGovernment(Government):
    """
    Agent reporting the payments for Sown Permanent Pastures
