...
from .custom_transformers import (TransformAdoptionFeatures,
...
class SBPAdoption(mesa.Model):
    ...
    def _upload_ml_models(self, ml_clsf_folder, ml_regr_folder):
        ...
        Load the ML models, fit them to the relative dataset and set the model
        attributes.
    ...
    def _set_munic_attributes_from_data_and_adoption_in_port(
        ...
        for munic in municipalities:
            ...
            munic.census_data = dict(munic_census_data)
